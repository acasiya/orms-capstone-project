...
urlpatterns = [
    ...
    path("staff-setup/status/", views.StaffAccountSetupStatusView.as_view(), name="staff_setup_status"),
    ...
    path("admin/create-citizen/", views.AdminCreateCitizenView.as_view(), name="admin_create_citizen"),
